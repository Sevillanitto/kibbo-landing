...
const GENERATORS = {
  ...
  'source-of-funds-package-generator': {
    ...
    // PLACEHOLDER — Gumroad product not yet created for "source-of-funds-package-generator".
    ...
    gumroad_product_id: 'PLACEHOLDER_SOF_PACKAGE_GENERATOR',
    prompt_template:
  ...
  'exchange-account-freeze-response': {
    ...
    // PLACEHOLDER — Gumroad product not yet created for "exchange-account-freeze-response".
    // Create it (license-verified generator, "Generate a unique license key per sale"
    // enabled) and replace with the real gumroad_product_id, or /unlock will always fail.
    gumroad_product_id: 'PLACEHOLDER_ACCOUNT_FREEZE_RESPONSE',
    prompt_template:
  ...
  'crypto-complaint-generator': {
    ...
    // PLACEHOLDER — Gumroad product not yet created for "crypto-complaint-generator".
    // Create it (license-verified generator, "Generate a unique license key per sale"
    // enabled) and replace with the real gumroad_product_id, or /unlock will always fail.
    gumroad_product_id: 'PLACEHOLDER_CRYPTO_COMPLAINT_GENERATOR',
    prompt_template:
