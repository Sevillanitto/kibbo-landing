---
title: "How to Ask a Company to Delete Your Data: Master the Right to Erasure"
published: false
description: "Article 17 GDPR gives you the Right to Erasure. What it forces a company to delete, the one-month deadline (extendable to three for complex requests only if you're notified in time), lawful refusals, and downstream deletion by third parties."
...
**More:** [GDPR Rights Request generator (Erasure / Access)](https://www.getkibbo.com/generate/eu-gdpr-rights-request.html) · [Right of Access Under GDPR](https://www.getkibbo.com/blog/eu-right-of-access-sar-guide)

**Sources:** Regulation (EU) 2016/679 (GDPR) — Article 17 (right to erasure), Article 12(3) (response deadline and extension) · European Data Protection Board — guidance on the right to erasure
